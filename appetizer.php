...
<head>
    ...
    <title>Pa's Appetizers | Pa's Italiano</title>
...
<div class="container-fluid">
        ...
        <div class="col-12 pt-3">
                <nav aria-label="breadcrumb" class="text-black">
                    <ol class="breadcrumb ">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a class="text-decoration-none text-black" href="appetizer.php">Appetizers</a></li>
                    </ol>
                </nav>
            </div>    
    

    <div class="col-12 head4">
        <div class="row">
            <div class="col-12">
                <div class="row">
                <p class="text-center text-uppercase footer-text text-white" style="margin-top: 20px; font-size:72px;">APPETIZERS</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 bg-black mb-2">
        ...
        <div class="offset-lg-1 col-12 col-lg-10 mt-2">
            ...
            <div class="col-12 col-lg-7 mt-2 mb-1">
                <input type="text" class="form-control rounded-0" placeholder="Use keywords to search for pizzas..." id="t" />
            </div>
            <div class="col-12 col-lg-2 mt-2 mb-1 d-grid">
                <button class="btn btn-warning rounded-0" onclick="advancedSearchStart4(0);"><i class="bi bi-search">&nbsp;&nbsp;</i>Search</button>
            </div>
            <div class="col-12 col-lg-3 mt-2 mb-1 d-grid">
                <button class="btn btn-success rounded-0" onclick="clearSorting4();"><i class="bi bi-trash">&nbsp;&nbsp;</i>Reset Results</button>
            </div>            
            </div>
        </div>
        ...
        <div class="offset-lg-1 col-12 col-lg-10">
            ...
            <div class="col-12">
                ...
                <div class="col-12 col-lg-4 mt-2 mb-lg-2">
                    ...
                    <option value="0">Select your favourite series (not selected)</option>
                    <?php
                        $cat_rs=Database::search("SELECT * FROM `series` WHERE `category_id`=4");
                ...
                <div class="col-12 col-lg-4 mt-2 mb-lg-2">
                    <input type="text" class="form-control rounded-0 mt-1" placeholder="Appetizers prized from..." id="pf"/>
                </div>
                <div class="col-12 col-lg-4 mt-2 mb-3">
                    <input type="text" class="form-control rounded-0 mt-1" placeholder="Appetizers priced to..." id="pt"/>
                </div>
    ...
    <div class="col-12 rounded mb-2">
        <div class="row">
            <div class="offset-lg-8 offset-4 col-lg-4 col-8 mt-2 mb-2">
                <select class="form-select border border-start-0 border-top-0 border-end-0 border-3 border-success shadow-none rounded-0" id="sortby" onchange="advancedSearchStart4(0);">
    ...
    <div class="col-12 mt-1 mb-1">
                            <div class="row" id="searchResultViewer4">
...
$pageno;
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `category_id`=4");
                                        ...
                                        $selected_rs =  Database::search("SELECT * FROM `product` WHERE `category_id`=4
