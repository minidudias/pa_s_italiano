...
<body style="background-image: linear-gradient(90deg,#f32b2b,#ffffff,#31c48d);">
...
<?php 
        ...
        include "h.php";  
            ...
            if (isset($_SESSION["logged-in-user"])) {
                ...
                $invoice_rs = Database::search("SELECT * FROM `invoice` WHERE `user`='" . $mail . "' ORDER BY `date` DESC");
                                ...
                                <div class="card mb-3 mx-0 col-12 rounded-0 bg-black">
                                    <div class="row g-0">
                                        ...
                                        <div class="card-body d-grid">
                                            ...
                                            <a class="btn btn-danger mb-2 rounded-0 " onclick='removeFromWatchList(<?php echo $watch_data["id"]; ?>);'>Delete</a>
                                        </div>
                                    </div>
